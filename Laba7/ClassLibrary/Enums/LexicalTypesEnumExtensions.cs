  ...
  public static class LexicalTypesEnumExtensions
  {
    ...
    public static string ToDetailedString(this LexicalTypesEnum type)
    {
        return type switch
        {
          ...
          LexicalTypesEnum.IntType => "целого типа",
          LexicalTypesEnum.FloatType => "вещественного типа",
          LexicalTypesEnum.Coercion => "преобразование типа",
    ...
    public static string ToDescribString(this LexicalTypesEnum type)
    {
      return type switch
      {
        ...
        LexicalTypesEnum.IntType => "целый",
        LexicalTypesEnum.FloatType => "вещественный",
        LexicalTypesEnum.Coercion => "Int2Float",
        LexicalTypesEnum.Unknown => "Неизвестный символ",
          _ => "Неопределенный тип"
      };
    }
